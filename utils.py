...
def regularizing_loss(pc_a: torch.Tensor, pc_b: torch.Tensor, pred_a: torch.Tensor,
...
def drop_point(pc: torch.Tensor, pc2: torch.Tensor, point_size: int, drop_num: int):
